...
export interface Quantity {
  ...
  circular?: boolean;
  /**
   * Decimal places, chosen from what the instrument actually resolves.
   *
   * Used for the readout *and* for the stored series, which is why it earns
   * a place here rather than in a formatter. Rounding each column to its own
   * precision is what makes the baked JSON compress smaller than a Float32
   * binary of the same data — short repetitive tokens are what gzip eats —
   * and it stops a series carrying eleven digits of a number an SBE37
   * resolves to three.
   */
  digits: number;
...
export const QUANTITIES: readonly Quantity[] = [
  ...
  Q({ key: 'wind_speed', label: 'Wind speed', short: 'U', units: 'm/s',
    colormap: 'cmo.speed', group: 'meteorology', rank: 10, digits: 2, floor: 0 }),
  Q({ key: 'u10', label: 'Wind speed at 10 m (neutral)', short: 'U₁₀', units: 'm/s',
    colormap: 'cmo.speed', group: 'derived', rank: 11, digits: 2, floor: 0,
  ...
  Q({ key: 'wind_gust', label: 'Wind gust', short: 'Ugust', units: 'm/s',
    colormap: 'cmo.speed', group: 'meteorology', rank: 12, digits: 2, floor: 0 }),
  Q({ key: 'wind_direction', label: 'Wind from direction', short: 'θw', units: '°',
    colormap: 'hsv', group: 'meteorology', rank: 13, digits: 1, floor: 0, ceiling: 360,
    circular: true }),
  Q({ key: 'air_pressure', label: 'Air pressure', short: 'P', units: 'hPa',
    colormap: 'cmo.dense', group: 'meteorology', rank: 20, digits: 2 }),
  Q({ key: 'air_temperature', label: 'Air temperature', short: 'Ta', units: '°C',
    colormap: 'cmo.thermal', group: 'meteorology', rank: 30, digits: 2 }),
  Q({ key: 'relative_humidity', label: 'Relative humidity', short: 'RH', units: '%',
    colormap: 'cmo.haline', group: 'meteorology', rank: 40, digits: 1, floor: 0, ceiling: 100 }),
  Q({ key: 'wind_east', label: 'Eastward wind', short: 'u', units: 'm/s',
    colormap: 'cmo.balance', group: 'meteorology', rank: 50, digits: 2 }),
  Q({ key: 'wind_north', label: 'Northward wind', short: 'v', units: 'm/s',
    colormap: 'cmo.balance', group: 'meteorology', rank: 51, digits: 2 }),
  Q({ key: 'wind_vertical', label: 'Vertical wind', short: 'w', units: 'm/s',
    colormap: 'cmo.balance', group: 'meteorology', rank: 52, digits: 2 }),
  Q({ key: 'wind_height', label: 'Wind sensor height', short: 'zw', units: 'm',
    colormap: 'cmo.deep', group: 'meteorology', rank: 60, digits: 2, floor: 0,
  ...
  Q({ key: 'sonic_temperature', label: 'Sonic temperature', short: 'Ts', units: '°C',
    colormap: 'cmo.thermal', group: 'meteorology', rank: 61, digits: 2 }),

  /* ------------------------------------------------------------ ocean -- */
  Q({ key: 'sea_temperature', label: 'Sea water temperature', short: 'T', units: '°C',
    colormap: 'cmo.thermal', group: 'ocean', rank: 10, digits: 4 }),
  Q({ key: 'skin_temperature', label: 'Sea surface skin temperature', short: 'Tskin',
    units: '°C', colormap: 'cmo.thermal', group: 'ocean', rank: 11, digits: 3,
  ...
  Q({ key: 'salinity', label: 'Practical salinity', short: 'SP', units: '',
    colormap: 'cmo.haline', group: 'ocean', rank: 20, digits: 4, floor: 0 }),
  Q({ key: 'conductivity', label: 'Conductivity', short: 'C', units: 'mS/cm',
    colormap: 'cmo.haline', group: 'ocean', rank: 21, digits: 4, floor: 0 }),
  Q({ key: 'oxygen_concentration', label: 'Dissolved oxygen', short: 'O₂',
    units: 'µmol/L', colormap: 'cmo.deep', group: 'ocean', rank: 30, digits: 2, floor: 0 }),
  Q({ key: 'oxygen_saturation', label: 'Oxygen saturation', short: 'O₂sat', units: '%',
    colormap: 'cmo.deep', group: 'ocean', rank: 31, digits: 2, floor: 0 }),
  Q({ key: 'chlorophyll', label: 'Chlorophyll', short: 'chl', units: 'µg/L',
    colormap: 'cmo.algae', group: 'ocean', rank: 40, digits: 4, floor: 0 }),
  Q({ key: 'cdom', label: 'CDOM', short: 'CDOM', units: 'ppb',
    colormap: 'cmo.matter', group: 'ocean', rank: 41, digits: 3, floor: 0 }),
  Q({ key: 'backscatter', label: 'Optical backscatter', short: 'bb',
    units: 'm⁻¹ sr⁻¹', colormap: 'cmo.turbid', group: 'ocean', rank: 42, digits: 6, floor: 0 }),
  Q({ key: 'current_east', label: 'Eastward current', short: 'ucur', units: 'm/s',
    colormap: 'cmo.balance', group: 'ocean', rank: 50, digits: 3 }),
  Q({ key: 'current_north', label: 'Northward current', short: 'vcur', units: 'm/s',
    colormap: 'cmo.balance', group: 'ocean', rank: 51, digits: 3 }),
  Q({ key: 'current_speed', label: 'Current speed', short: 'Ucur', units: 'm/s',
    colormap: 'cmo.speed', group: 'ocean', rank: 52, digits: 3, floor: 0 }),
  Q({ key: 'current_direction', label: 'Current direction', short: 'θcur', units: '°',
    colormap: 'hsv', group: 'ocean', rank: 53, digits: 1, floor: 0, ceiling: 360,
    circular: true }),

  /* ------------------------------------------------------------ waves -- */
  Q({ key: 'wave_height', label: 'Significant wave height', short: 'Hs', units: 'm',
    colormap: 'cmo.matter', group: 'waves', rank: 10, digits: 3, floor: 0 }),
  Q({ key: 'wave_period_dominant', label: 'Dominant wave period', short: 'Tp',
    units: 's', colormap: 'cmo.speed', group: 'waves', rank: 11, digits: 1, floor: 0 }),
  Q({ key: 'wave_period_mean', label: 'Mean wave period', short: 'Tm', units: 's',
    colormap: 'cmo.speed', group: 'waves', rank: 12, digits: 1, floor: 0 }),

  /* -------------------------------------------------------- radiation -- */
  Q({ key: 'par', label: 'Photosynthetically active radiation', short: 'PAR',
    units: 'µmol/m²/s', colormap: 'plasma', group: 'radiation', rank: 10, digits: 2, floor: 0 }),
  Q({ key: 'shortwave_down', label: 'Downwelling shortwave', short: 'SW',
    units: 'W/m²', colormap: 'plasma', group: 'radiation', rank: 20, digits: 2, floor: 0 }),
  Q({ key: 'shortwave_diffuse', label: 'Diffuse shortwave', short: 'SWdif',
    units: 'W/m²', colormap: 'plasma', group: 'radiation', rank: 21, digits: 2, floor: 0 }),
  Q({ key: 'longwave_down', label: 'Downwelling longwave', short: 'LW',
    units: 'W/m²', colormap: 'inferno', group: 'radiation', rank: 22, digits: 2, floor: 0 }),
  Q({ key: 'longwave_net', label: 'Net longwave', short: 'LWnet', units: 'W/m²',
    colormap: 'cmo.balance', group: 'radiation', rank: 23, digits: 2 }),

  /* --------------------------------------------------------- platform -- */
  Q({ key: 'battery_voltage', label: 'Battery voltage', short: 'Vbatt', units: 'V',
    colormap: 'cmo.speed', group: 'platform', rank: 5, digits: 2, floor: 0 }),
  Q({ key: 'sound_speed_air', label: 'Speed of sound in air', short: 'cair',
    units: 'm/s', colormap: 'cmo.speed', group: 'platform', rank: 6, digits: 2, floor: 0,
  ...
  Q({ key: 'depth', label: 'Depth', short: 'z', units: 'm',
    colormap: 'cmo.deep', group: 'platform', rank: 7, digits: 2, floor: 0,
  ...
  Q({ key: 'speed_over_ground', label: 'Speed over ground', short: 'SOG',
    units: 'm/s', colormap: 'cmo.speed', group: 'platform', rank: 10, digits: 3, floor: 0 }),
  Q({ key: 'course_over_ground', label: 'Course over ground', short: 'COG',
    units: '°', colormap: 'hsv', group: 'platform', rank: 11, digits: 1, floor: 0,
    ceiling: 360, circular: true }),
  Q({ key: 'heading', label: 'Heading', short: 'HDG', units: '°',
    colormap: 'hsv', group: 'platform', rank: 12, digits: 1, floor: 0, ceiling: 360,
    circular: true }),
  Q({ key: 'pitch', label: 'Pitch', short: 'pitch', units: '°',
    colormap: 'cmo.balance', group: 'platform', rank: 20, digits: 2 }),
  Q({ key: 'roll', label: 'Roll', short: 'roll', units: '°',
    colormap: 'cmo.balance', group: 'platform', rank: 21, digits: 2 }),
  Q({ key: 'wing_angle', label: 'Wing angle', short: 'wing', units: '°',
    colormap: 'cmo.balance', group: 'platform', rank: 30, digits: 1 }),
  Q({ key: 'wing_heading', label: 'Wing heading', short: 'wingHDG', units: '°',
    colormap: 'hsv', group: 'platform', rank: 31, digits: 1, circular: true }),
  Q({ key: 'wing_pitch', label: 'Wing pitch', short: 'wingP', units: '°',
    colormap: 'cmo.balance', group: 'platform', rank: 32, digits: 2 }),
  Q({ key: 'wing_roll', label: 'Wing roll', short: 'wingR', units: '°',
    colormap: 'cmo.balance', group: 'platform', rank: 33, digits: 2 }),
  Q({ key: 'heave', label: 'Heave', short: 'heave', units: 'm',
    colormap: 'cmo.balance', group: 'platform', rank: 40, digits: 3 }),
  Q({ key: 'heave_rate', label: 'Heave rate', short: 'dheave', units: 'm/s',
    colormap: 'cmo.balance', group: 'platform', rank: 41, digits: 3 }),
  Q({ key: 'altitude', label: 'Altitude', short: 'alt', units: 'm',
    colormap: 'cmo.deep', group: 'platform', rank: 50, digits: 2 }),
  Q({ key: 'velocity_north', label: 'Platform velocity, north', short: 'Vn',
    units: 'm/s', colormap: 'cmo.balance', group: 'platform', rank: 60, digits: 3 }),
  Q({ key: 'velocity_east', label: 'Platform velocity, east', short: 'Ve',
    units: 'm/s', colormap: 'cmo.balance', group: 'platform', rank: 61, digits: 3 }),
  Q({ key: 'velocity_down', label: 'Platform velocity, down', short: 'Vd',
    units: 'm/s', colormap: 'cmo.balance', group: 'platform', rank: 62, digits: 3 }),
  Q({ key: 'acceleration_x', label: 'Acceleration, x', short: 'ax', units: 'm/s²',
    colormap: 'cmo.balance', group: 'platform', rank: 70, digits: 3 }),
  Q({ key: 'acceleration_y', label: 'Acceleration, y', short: 'ay', units: 'm/s²',
    colormap: 'cmo.balance', group: 'platform', rank: 71, digits: 3 }),
  Q({ key: 'acceleration_z', label: 'Acceleration, z', short: 'az', units: 'm/s²',
    colormap: 'cmo.balance', group: 'platform', rank: 72, digits: 3 }),
  Q({ key: 'rotation_x', label: 'Rotation rate, x', short: 'gx', units: 'rad/s',
    colormap: 'cmo.balance', group: 'platform', rank: 73, digits: 4 }),
  Q({ key: 'rotation_y', label: 'Rotation rate, y', short: 'gy', units: 'rad/s',
    colormap: 'cmo.balance', group: 'platform', rank: 74, digits: 4 }),
  Q({ key: 'rotation_z', label: 'Rotation rate, z', short: 'gz', units: 'rad/s',
    colormap: 'cmo.balance', group: 'platform', rank: 75, digits: 4 }),
  Q({ key: 'magnetic_strength', label: 'Magnetic field strength', short: '|B|',
    units: 'µT', colormap: 'cmo.dense', group: 'platform', rank: 80, digits: 2, floor: 0 }),
  Q({ key: 'magnetic_x', label: 'Magnetic field, x', short: 'Bx', units: 'µT',
    colormap: 'cmo.balance', group: 'platform', rank: 81, digits: 2 }),
  Q({ key: 'magnetic_y', label: 'Magnetic field, y', short: 'By', units: 'µT',
    colormap: 'cmo.balance', group: 'platform', rank: 82, digits: 2 }),
  Q({ key: 'magnetic_z', label: 'Magnetic field, z', short: 'Bz', units: 'µT',
    colormap: 'cmo.balance', group: 'platform', rank: 83, digits: 2 }),
  ...
  Q({ key: 'sensible_heat_flux', label: 'Sensible heat flux', short: 'QS',
    units: 'W/m²', colormap: 'cmo.balance', group: 'derived', rank: 20, digits: 2,
  ...
  Q({ key: 'latent_heat_flux', label: 'Latent heat flux', short: 'QL',
    units: 'W/m²', colormap: 'cmo.balance', group: 'derived', rank: 21, digits: 2,
    note: "Published by PMEL as part of the Arctic flux products, not computed here." }),
  Q({ key: 'wind_stress', label: 'Wind stress', short: 'τ', units: 'N/m²',
    colormap: 'cmo.speed', group: 'derived', rank: 12, digits: 4, floor: 0,
  ...
  Q({ key: 'dewpoint', label: 'Dewpoint temperature', short: 'Td', units: '°C',
    colormap: 'cmo.thermal', group: 'derived', rank: 30, digits: 2,
  ...
  Q({ key: 'specific_humidity', label: 'Specific humidity', short: 'q',
    units: 'g/kg', colormap: 'cmo.haline', group: 'derived', rank: 31, digits: 3, floor: 0 }),
  Q({ key: 'sa', label: 'Absolute Salinity', short: 'SA', units: 'g/kg',
    colormap: 'cmo.haline', group: 'derived', rank: 40, digits: 4, floor: 0,
  ...
  Q({ key: 'ct', label: 'Conservative Temperature', short: 'Θ', units: '°C',
    colormap: 'cmo.thermal', group: 'derived', rank: 41, digits: 4 }),
  Q({ key: 'sigma0', label: 'Potential density anomaly σ₀', short: 'σ₀',
    units: 'kg/m³', colormap: 'cmo.dense', group: 'derived', rank: 42, digits: 4 }),
  Q({ key: 'spice0', label: 'Spiciness π₀', short: 'π₀', units: 'kg/m³',
    colormap: 'cmo.balance', group: 'derived', rank: 43, digits: 4 }),
  Q({ key: 'sound_speed', label: 'Sound speed', short: 'c', units: 'm/s',
    colormap: 'cmo.speed', group: 'derived', rank: 44, digits: 3, floor: 0 }),
];
